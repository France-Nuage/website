    ...
    <nuxt-layout>
      <div class="relative isolate px-6 pt-14 lg:px-8 bg-gray-50">
        <div class="mx-auto max-w-4xl pt-20 pb-16 sm:pt-28 lg:pt-32">
          ...
          <!-- Titre Principal -->
          <h1 class="text-3xl font-bold text-gray-900 mb-8">À Propos de France-Nuage</h1>
          ...
          <section class="mb-10">
            <h2 class="text-2xl font-semibold text-gray-800 mb-4">Pourquoi France-Nuage ?</h2>
            <p class="text-gray-700">
              Nous en avions assez des modèles traditionnels de cloud où l’utilisateur perd la maîtrise de ses données. France-Nuage a été conçu pour offrir aux entreprises la <strong>puissance du cloud</strong> tout en leur permettant de conserver le <strong>contrôle total</strong> sur leur infrastructure. Notre objectif est de fournir une solution hybride qui combine la flexibilité du cloud public avec la sécurité et l'indépendance d'une infrastructure hébergée localement.
            </p>
          </section>
          ...
          <section class="mb-10">
            ...
            <p class="text-gray-700">
              Fondée par une équipe de passionnés de technologie, France-Nuage est née de la volonté de reprendre le contrôle des infrastructures cloud. En tant qu'anciens de grandes entreprises du numérique, nous avons vu de première main les défis posés par les solutions cloud traditionnelles : <strong>coûts opaques</strong>, <strong>dépendance à un fournisseur</strong>, et <strong>sécurité incertaine</strong>. Nous avons donc décidé de construire une solution qui permette aux entreprises de gérer leurs données de manière indépendante, sécurisée et transparente.
            </p>
          </section>
          ...
          <section class="mb-10">
            ...
            <ul class="list-disc list-inside text-gray-700 space-y-2">
              <li><strong>Souveraineté :</strong> Vos données vous appartiennent et restent sous votre contrôle.</li>
